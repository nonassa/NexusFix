...
// ============================================================================
// FIX 5.0 NewOrderSingle Message (MsgType = D)
// ============================================================================

/// FIX 5.0 NewOrderSingle message (35=D)
/// Used with FIXT.1.1 transport layer
/// Supports ApplVerID for per-message application version specification
struct NewOrderSingle {
        ...
        std::span<const char> buffer) noexcept
    {
        ...
        msg.currency = p.get_string(15);
        msg.min_qty = p.get_field(110).as_qty();
        msg.max_floor = p.get_field(111).as_qty();
    ...
    public:
        ...
        [[nodiscard]] std::span<const char> build(MessageAssembler& asm_) const noexcept {
            ...
            // Include ApplVerID if explicitly set (optional per-message override)
...
// ============================================================================
// FIX 5.0 OrderCancelRequest Message (MsgType = F)
// ============================================================================

/// FIX 5.0 OrderCancelRequest message (35=F)
